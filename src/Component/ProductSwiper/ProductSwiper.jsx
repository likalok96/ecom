...
import ProductSwipeTitle from '../ProductSwiperTitle/ProductSwipeTitle'
    ...
    <div className='ps_wrapper'>
      ...
      <div className='swipe_wrapper'>
        ...
        >
            ...
            {(productQuery.isFetching ) && Array(5).fill(false).map((_,index)=>
            <SwiperSlide key={index}> <ProductCard2 prd={_} discount={true}/> </SwiperSlide>
            )}
